...
<body style="padding:0px; width:85mm; margin:auto; font-size:13px;">
    <style>
        .tb {
            display: block;
            width: 100%;
    ...
    <div class="container" style="margin:0px; padding:0px; width:100%; margin:auto;">
        ...
        <div id="mydiv" style="page-break-after: always;">
                 ...
                 <h3 style="text-align:center; font-size:20px; margin-bottom:0px; font-family:'Times New Roman', Times, serif; font-weight:bold">OFFICE COFFEE</h3>
                </div>
            ...
            <div class="product" style="padding-left: 34px;">

                <table class="tb2" align="center">
                    <tr>
                        <td>Tên món</td>
                        <td  align="right">ádasdasdasdasdasd</td>
        ...
        <div style="margin-top:18px;">
            <div style="text-align: center;"><b>Giá đã bao gồm 10% VAT </b></br></><i>Cảm ơn quí khách và hẹn gặp lại</i></br>
                Mật khẩu wifi: officecoffee
                <br />
            </div>
